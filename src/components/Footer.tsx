      ...
      <div className="section-container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-4">
            <h3 className="text-2xl font-display font-bold">InternMate</h3>
            <p className="opacity-80">
              Matching students with internships that actually make sense for their future.
            </p>
            <div className="flex space-x-4 pt-2">
              <a href="#" className="hover:text-internmate-yellow transition-colors">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="opacity-80 hover:opacity-100 transition-opacity">For Students</a></li>
              <li><a href="#" className="opacity-80 hover:opacity-100 transition-opacity">For Employers</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="opacity-80 hover:opacity-100 transition-opacity">GDPR</a></li>
            </ul>
          </div>
