...
const steps = [
  {
    ...
    description: "Simply upload your resume and tell us what you love. No experience? No problem! We have plenty of entry-level internships waiting for you.",
    emoji: "📄"
  },
  {
    title: "Swipe right on internships",
    description: "Swipe right on internships that catch your eye. Our AI matchmaker finds opportunities that actually fit your vibe, skills, and career goals.",
    emoji: "👉"
  },
  {
    title: "Find your perfect match",
    description: "Apply with one tap, chat directly with employers, and land that dream internship - even with zero experience! It's that simple!",
    emoji: "🎯"
  }
];
